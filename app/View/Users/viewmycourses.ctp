...
<table>
	...
	<?php foreach($courses as $k => $course): ?>
		<tr>
			...
			<td><?php echo $this->Html->link('Asistencia',array('controller'=>'users','action'=>'asistencias',$course['Career']['id'],$course['Course']['semester'],$course['Course']['id'],$course['User']['id'])); ?></td>
		</tr>
	<?php endforeach;?>
</table>